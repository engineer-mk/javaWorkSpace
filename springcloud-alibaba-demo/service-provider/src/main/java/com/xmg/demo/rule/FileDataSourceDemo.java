...
public class FileDataSourceDemo{
    ...
    private void listenRules() throws Exception {
        ...
        String flowRulePath = URLDecoder.decode(classLoader.getResource("json/FlowRule.json").getFile(), "UTF-8");
        String degradeRulePath = URLDecoder.decode(classLoader.getResource("json/DegradeRule.json").getFile(), "UTF-8");
        String systemRulePath = URLDecoder.decode(classLoader.getResource("json/SystemRule.json").getFile(), "UTF-8");
