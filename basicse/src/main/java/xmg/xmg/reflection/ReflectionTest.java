package xmg.xmg.reflection;

import xmg.xmg.reflection.support.Info;
import xmg.xmg.reflection.support.User;
...
public class ReflectionTest {
    ...
    public void test1() throws ClassNotFoundException {
        ...
        //3.Class静态方法
        final Class<?> c3 = Class.forName("xmg.xmg.reflection.support.User");
        //4.类加载器
        final ClassLoader classLoader = ReflectionTest.class.getClassLoader();
        final Class<?> c4 = classLoader.loadClass("xmg.xmg.reflection.support.User");
    ...
    public void test2() throws ClassNotFoundException {
        final Class<?> aClass = Class.forName("xmg.xmg.reflection.support.User");
        //获取类及其父类中public属性
